    ...
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        description: Yup.string().max(5000),
          ...
          (start, schema) =>
            start &&
            schema.min(start, "The end date should be after start date")
        ),
        start: Yup.date(),
      ...
      onSubmit={async (
        ...
        try {
          ...
          setSubmitting(false);
          enqueueSnackbar("The calendar has been successfully updated!", {
            variant: "success",
            anchorOrigin: {
              vertical: "bottom",
              horizontal: "center",
        ...
        <form onSubmit={handleSubmit}>
          <Box p={3}>
            <Typography variant="h4">
              {isCreating ? "Create new calendar event" : "Edit calendar event"}
            </Typography>
          </Box>
          <Divider />
          <Box px={3} py={2}>
          ...
          >
            <Box>
              {!isCreating && (
                <Tooltip arrow title="Delete this event">
            ...
            <Box>
              ...
              <Button
                ...
                color="primary"
              >
                {isCreating ? "Add meeting" : "Save modifications"}
              </Button>
            </Box>
          </CardActionsWrapper>
        </form>
