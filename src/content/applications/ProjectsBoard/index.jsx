...
function ApplicationsProjectsBoard() {
  ...
  const tabs = [
    { value: "react_migration", label: "React Project Migration" },
  ...
  const handleDragEnd = async ({ source, destination, draggableId }) => {
    try {
      ...
      enqueueSnackbar("Task has been successfully moved", {
        variant: "info",
        anchorOrigin: {
          vertical: "bottom",
          horizontal: "center",
          ...
          <TabsContainerWrapper>
            ...
            >
              ...
              <Tab
                href="#"
                label={
                  <Tooltip placement="top" arrow title="Add new project">
                    <AddTwoToneIcon />
                  </Tooltip>
                }
                disabled
          ...
          <TasksWrapperContent>
            <DragDropContext onDragEnd={handleDragEnd}>
              <TasksWrapper>
                ...
                <Tooltip arrow title="Add a new project panel">
                  <CardAddAction>
                    <CardActionArea
                      sx={{
                        px: 1,
