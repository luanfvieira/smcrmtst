          ...
          <Box display="flex" alignItems="center" p={2}>
            ...
            <Box pl={1}>
              ...
              <Typography variant="subtitle2">
                Acccess this page in order to manage and customize all aspects
                of your profile data and accounts.
              </Typography>
            </Box>
          </Box>
          <Divider />
        ...
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            ...
            <Box pl={1}>
              ...
              <Typography variant="subtitle2">
                Control everything related to your profile and trading accounts
        ...
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            ...
            <Box pl={1}>
              ...
              <Typography variant="subtitle2">
                You can view, manage and customize your wallets and balances
                from this wallets page.
              </Typography>
            </Box>
          </Box>
          <Divider />
        ...
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            ...
            <Box pl={1}>
              ...
              <Typography variant="subtitle2">
                Complete your profile verifications to take full advantage of
