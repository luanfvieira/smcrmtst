      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant="subtitle2">Monthly sales reports</Typography>
          </Box>
          <Text color="error">
        ...
        >
          <Box>
            ...
            <Typography variant="subtitle2">Last month targets</Typography>
          </Box>
          <Text color="warning">
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant="subtitle2">Visitors last week</Typography>
          </Box>
          <Text color="success">
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant="subtitle2">Total products ordered</Typography>
          </Box>
          <Text color="info">
