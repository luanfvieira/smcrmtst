    ...
    <Card variant="outlined">
      ...
      <List>
        ...
        >
          ...
          <ListItemText primary={<Typography variant="h4">User</Typography>} />
          <Box>
            <Typography variant="h4">
        ...
        >
          ...
          <ListItemText primary={<Typography variant="h4">Sales</Typography>} />
          <Box>
            <Typography variant="h4">
        ...
        >
          ...
          <ListItemText primary={<Typography variant="h4">Stats</Typography>} />
          <Box>
            <Typography variant="h4">
