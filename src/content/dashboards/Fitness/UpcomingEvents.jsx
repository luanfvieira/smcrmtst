      ...
      <List disablePadding component="div">
        <ListItemWrapper alignItems="flex-start">
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              You will learn how to have a healthy body and how to stay fit in
              this event.
            </Typography>
          </Box>
        </ListItemWrapper>
        ...
        <ListItemWrapper alignItems="flex-start">
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Three day course that will help you harness your inner power in
        ...
        <ListItemWrapper alignItems="flex-start">
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Learn how to better manage the stresses of daily life, improve
              your overall health.
            </Typography>
          </Box>
        </ListItemWrapper>
