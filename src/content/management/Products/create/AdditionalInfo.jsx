      ...
      <Box p={3}>
        ...
        {currentTab === "inventory" && (
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Box display="flex" alignItems="center">
                ...
                <Tooltip
                  arrow
                  placement="top"
                  title="This field helps identify the current product stocks"
                >
                  <IconButton
                    size="small"
                    sx={{
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth variant="outlined">
                <InputLabel htmlFor="stock_status">Stock Status</InputLabel>
                <Select
                  native
                  label="Stock Status"
                  inputProps={{
        ...
        {currentTab === "shipping" && (
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Box display="flex" alignItems="center">
                ...
                <Tooltip
                  arrow
                  placement="top"
                  title="Your have the weight units set to kilograms in your app settings"
                >
                  <IconButton
                    size="small"
                    sx={{
            ...
            <Grid item xs={12}>
              <FormControl fullWidth variant="outlined">
                <InputLabel htmlFor="shipping_class">Shipping class</InputLabel>
                <Select
                  native
