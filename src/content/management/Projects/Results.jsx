...
const Results = ({ projects }) => {
  ...
  const handleDeleteCompleted = () => {
    ...
    enqueueSnackbar("The projects has been deleted successfully", {
      variant: "success",
      anchorOrigin: {
        vertical: "top",
        horizontal: "right",
          ...
          {!selectedBulkActions && (
            ...
            >
              <Box>
                ...
                <b>{paginatedProjects.length}</b> <b>Projects</b>
              </Box>
              <TablePagination
                component="div"
                        ...
                        >
                          ...
                          <TableCell>
                            ...
                            <Typography noWrap color="text.secondary">
                              Started: {format(project.dueDate, "MMMM dd yyyy")}
                            </Typography>
                          </TableCell>
                          <TableCell>
              ...
              >
                <>
                  <Box display="flex" alignItems="center">
                    <Tooltip arrow placement="top" title="Select all projects">
                      <Checkbox
                        checked={selectedAllProjects}
                        indeterminate={selectedSomeProjects}
                        onChange={handleSelectAllProjects}
            ...
            <>
              ...
              >
                <Box>
                  ...
                  <b>{limit}</b> of <b>{filteredProjects.length}</b>{" "}
                  <b>Projects</b>
                </Box>
                <TablePagination
                  component="div"
