    ...
    <Container maxWidth="lg">
      ...
      >
        <Grid item md={6} pr={{ xs: 0, md: 3 }}>
          <LabelWrapper color="success">Version 3.1</LabelWrapper>
          <TypographyH1
            sx={{
              mb: 2,
            }}
            variant="h1"
          >
            Tokyo React Javascript Admin Dashboard
          </TypographyH1>
          <TypographyH2
            sx={{
              lineHeight: 1.5,
            ...
            fontWeight="normal"
          >
            High performance React template built with lots of powerful MUI
